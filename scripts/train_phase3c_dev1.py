"""One frozen DEV1 seed-condition run; no B or replay path exists."""
...
def main() -> None:
    ...
    schedule = read("research/protocols/phase3c_dev1_schedule.json")["by_seed"][str(args.seed)]
    ...
    record = {"phase": "3C-DEV1", "condition": args.condition, "seed": args.seed,
