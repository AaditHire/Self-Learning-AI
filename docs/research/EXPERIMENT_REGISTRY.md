...
| EXP-0006 | Frozen-model development-only elicitation protocol selection | 2026-09-20 | Based on `e88d49255abd7b9d1a4497d3d89dbdc4d3a8a5ae`; frozen in Phase 1R preregistration commit | Qwen commit `2e1fd397…f1098a` | None | Development tasks canonical `a5163438…b6a3b` | Deterministic JAR `42478b35…b2a2fb` | `c5391a6d…ee21d` | 20260920 (greedy) | RTX 3060 Laptop 6 GB; FP16 | `research/results/EXP-0006/phase1r_development_evaluation.json` | Pending frozen-model inference | FROZEN / NOT RUN | N/A |
