...
The available adapters and records are inventoried in `research/manifests/phase3c_dev2_partial_artifact_preservation.json`. A local copy is only the first preservation step; remote fresh-clone verification must be reported separately before calling archival complete. **STOP for independent scientific review.**
